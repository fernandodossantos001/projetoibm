...
public class TestePaciente {
	...
	public static void main(String[] args) {
		...
		//	System.out.println(PacienteBO.consutlarPaciente(30));
			...
			System.out.println(PacienteBO.alterarDadosPaciente(new Paciente(36, "Zé bunitinho", "zeBunitinho@zezihno.com", "3/12/1940", "zezinhao", "zezez2e", 1, " ", "masculino", 36, 47349383, 64444444, "a",4)));
