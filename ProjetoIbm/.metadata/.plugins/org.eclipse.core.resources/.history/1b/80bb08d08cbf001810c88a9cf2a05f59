...
public class TesteNumero {
	...
	public static void main(String[] args) throws Exception{
		...
		for (Consulta consultas: listaConsultas) {
			...
			System.out.println();
			System.out.println("Cod a ser avaliado pac: " + consultas.getCodPaciente());
			
			System.out.println();
			for(Consulta x : listaConsultPaciente) {
				if(x.getCodPaciente() == paciente.getCodPaciente()) {
					System.out.println(x.getCodPaciente() + " Cod. Paciente ja existe");
					isTrueP = true;
					break;
				}
			...
			System.out.println();
			System.out.println();
			for(Consulta y : listaConsultPaciente) {
				System.out.println("Paciente: " + y.getCodPaciente());
			}
			System.out.println();
