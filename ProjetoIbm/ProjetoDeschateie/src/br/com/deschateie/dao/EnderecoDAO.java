...
public class EnderecoDAO {
	...
	public String atualizarEnderecoPsicologo(Endereco endereco)throws Exception{
	...
	public String atualizarEnderecoVoluntario(Endereco endereco)throws Exception{
		stmt= con.prepareStatement("UPDATE T_SCP_ENDERECO SET DS_LOGRADOURO = ?,"
									+ "DS_TIPO = ?,"
									+ "NR_NUMERO = ?,"
									+ "DS_COMPLEMENTO = ?,"
